...
BLOG_AUTHOR = "Luc Saffre"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ((
            ("/vtt", "Vigala Wikipedia Workshop"),
            ("/vcc", "Vigala Code Camps"),
            ("/vilma", "The Vilma project"),
            ), "Projects"),
        ((
            ("/blog", "Blog"),
    ...
    "et": (
        ...
        ((
            ("/vtt", "Vigala Vikipeedia töötuba"),
            ("/vcc", "Vigala programmeerimislaager"),
            ), "Üritused"),
        ((
            ("/et/about", "Rumma & Ko"),
            ("/et/team", "Meeskond"),
    ...
    "fr": (
        ...
        ((
            ("/fr/about", "Rumma & Ko"),
            ("/fr/team", "Notre équipe"),
            # ("/fr/views", "Philosophie"),
            ("/fr/jobs", "Jobs"),
            ), "à propos"),
        ("/fr/contact", "Contact"),
    ),
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="contact">Rumma &amp; Ko</a> - Powered by <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
